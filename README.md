## rostune (kinetic) - 1.0.7-0

The packages in the `rostune` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic rostune --edit` on `Wed, 01 Nov 2017 09:40:17 -0000`
